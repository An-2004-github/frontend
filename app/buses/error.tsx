...
export default function BusesError({ error, reset }: { error: Error; reset: () => void }) {
    useEffect(() => { console.error(error); }, [error]);
    return (
        <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4">
            <div className="text-5xl mb-4">🚌</div>
            <h2 className="text-xl font-bold text-slate-800 mb-2">Không thể tải danh sách xe khách</h2>
